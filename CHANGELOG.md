...
- Side effect worth knowing: under a cap, a method now gets a share of what is left, so
  an attempt can end below `WithAttemptTimeout`. Leave the cap unset for the full ceiling.
